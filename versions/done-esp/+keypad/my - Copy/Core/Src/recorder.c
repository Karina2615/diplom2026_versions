 ...
 *
 * Buffer layout (96 KB total, 48 000 samples × 2 B = 3.0 s @ 16 kHz):
 ...
 *
 * Sample-rate conversion (16 kHz → 44.1 kHz)
 * -------------------------------------------
 * Linear interpolation with Q16.16 fixed-point position accumulator.
 * Increment = round((16000 << 16) / 44100) = 23778.
 */
...
#define SRC_INC  23778u   /* round((16000 << 16) / 44100) */
