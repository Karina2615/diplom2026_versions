...
#define REC_SAMPLE_RATE    9070u   /* 48 MHz / 84 / 63 — matches TIM3 config */
#define REC_BUFFER_SIZE   48000u   /* CCM 32000 + SRAM 16000 — ~5.3 s @ 9070 Hz (SRAM half freed for stack) */
