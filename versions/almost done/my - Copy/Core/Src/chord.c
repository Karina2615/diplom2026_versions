...
#define SILENCE_THRESH      5.0e3f    /* very low — temporal gate handles noise */
#define CHORD_HOLD_WINDOWS  3u        /* ~192 ms of consistent detection        */
#define CHORD_SILENCE_RESET 5u        /* silent frames before clearing display  */
